...
public interface MateriaisFerramenta {
    ...
    ToolMaterial REINFORCED_COPPER = new ToolMaterial(BlockTags.INCORRECT_FOR_STONE_TOOL, 131, 2.0F, 100.0F, 14, ItemTags.STONE_TOOL_MATERIALS);
    ToolMaterial REINFORCED_EMERALD = new ToolMaterial(BlockTags.INCORRECT_FOR_STONE_TOOL, 131, 2.0F, 1.0F, 14, ItemTags.STONE_TOOL_MATERIALS);

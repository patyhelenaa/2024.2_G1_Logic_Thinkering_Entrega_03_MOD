...
public interface MateriaisFerramenta {
    ...
    ToolMaterial REINFORCED_EMERALD = new ToolMaterial(BlockTags.INCORRECT_FOR_STONE_TOOL, 250, 6.5F, 3.0F, 14, ItemTags.STONE_TOOL_MATERIALS);
    ToolMaterial REINFORCED_AMETHYST = new ToolMaterial(BlockTags.INCORRECT_FOR_STONE_TOOL, 500, 6.5F, 5.0F, 14, ItemTags.STONE_TOOL_MATERIALS);

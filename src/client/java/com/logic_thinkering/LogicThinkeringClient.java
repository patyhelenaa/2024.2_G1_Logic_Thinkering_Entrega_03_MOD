            ...
            dispatcher.register(CommandManager.literal("logic_thinkering_book")
                    .executes(context -> {
                        ...
                        List<BookPage> pages = List.of(
                                new BookPage("Introdução à Eletrônica Digital",
                                ...
                                new BookPage("Circuitos Digitais",
